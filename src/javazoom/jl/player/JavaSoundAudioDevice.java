...
public class JavaSoundAudioDevice extends AudioDeviceBase
{
	...
	// ADDITIONAL METHODS FOR VOLUME CONTROL
	// Credit: user ChrisH on stackoverflow.com
	// http://stackoverflow.com/questions/648107/changing-volume-in-java-when-using-jlayer
	/**
	 * set device gain
	 * 
	 * @param gain updated gain
	 */
	public void setLineGain(float gain)
	{
		...
		if((gain > volumeControl.getMinimum()) && (gain < volumeControl.getMaximum()))
			volumeControl.setValue(gain);
	}
	
	/**
	 * get the current gain for the source
	 * 
	 * @return source's current gain
	 */
	...
	/**
	 * get the minimum gain for the source
	 * 
	 * @return source's minimum gain
	 */
	...
	/**
	 * get the maximum gain for the source
	 * 
	 * @return source's maximum gain
	 */
	...
	// ADDITIONAL METHODS FOR GETTING CURRENT FRAME
	// These methods are used for determining the current location in the song
	// (in frames for the sake of sending the start frame to clients).
	/**
	 * get the source's current frame position
	 * 
	 * @return audio frame the source is currently on
